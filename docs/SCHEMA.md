...
implementing atom (possibly RQN-less) directly. Each pass considers only
entries still unmatched and skips on any ambiguity. The pass sequence and its
